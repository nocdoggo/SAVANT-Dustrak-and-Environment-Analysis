function rendering(data_dir, fid, filename, fileDate, M, scanType, snrBound, tag_digit, ang_label)
...
rangDist = str2num(rang{1});
        ...
        saveas(gcf, strcat(scanType, "_", fileDate, "_", num2str(tag_digit), "_", ang_label, "_Doppler.png"))
...
%         end
        ...
        saveas(gcf, strcat(scanType, "_", fileDate, "_", num2str(tag_digit), "_", ang_label, "_Backscater.png"))
