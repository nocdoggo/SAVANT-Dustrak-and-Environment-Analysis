...
if isfile(HPfile)        % Check speed file at first
    isHPExist = 'Y';
    % fprintf('Pressure and humidity variables exist.\n');
    errmsg('Magenta','Pressure and humidity variables exist. \n');
else
    isHPExist = 'N';
    % fprintf('Pressure and humidity variables do not exist.\n');
    errmsg('red','Pressure and humidity variables do not exists. \n');
end
