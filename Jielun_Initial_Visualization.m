...
if (isWindExist == 'Y') && (isSpeedExist == 'Y')
    ...
    for hours = 1:5
        ...
        x_arr = [mean(dspd_0_85m_uconv_A((tempStart+ (hours-1) * 12):(tempStart + (hours) * 12 - 1))),...
            mean(dvtemp_2_25m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_8m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 6:12
        ...
        x_arr = [mean(dspd_0_85m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_2_25m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_8m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 1:5
        ...
        x_arr = [mean(dspd_2_25m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_7_25m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_9_25m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_12_5m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_17_5m_lconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 6:12
        y_arr = [2.25, 3.75, 5.25, 7.25, 9.25, 12.5, 17.5];
        hours = hours - 5;
        x_arr = [mean(dvtemp_2_25m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_7_25m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_9_25m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_12_5m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_17_5m_lconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 1:5
        ...
        x_arr = [ mean(dvtemp_2_25m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_7_25m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_9_25m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_12_5m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_17_5m_rel_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 6:12
        y_arr = [ 2.25, 3.75, 5.25, 7.25, 9.25, 12.5, 17.5];
        hours = hours - 5;
        x_arr = [mean(dvtemp_2_25m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_7_25m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_9_25m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_12_5m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_17_5m_rel_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 1:5
        ...
        x_arr = [mean(dvtemp_2_25m_init_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_init_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_init_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_8m_init_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 6:12
        y_arr = [2.25, 3.75, 5.25, 8.00];
        hours = hours - 5;
        x_arr = [mean(dvtemp_2_25m_init_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_init_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_init_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_8m_init_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 1:5
        ...
        x_arr = [mean(dvtemp_2_25m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_8m_uconv_A((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
    ...
    for hours = 6:12
        y_arr = [2.25, 3.75, 5.25, 8.00];
        hours = hours - 5;
        x_arr = [mean(dvtemp_2_25m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_3_75m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_5_25m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1))),...
            mean(dvtemp_8m_uconv_B((tempStart+ (hours-1) * 12):(tempStart+ (hours) * 12 - 1)))];
