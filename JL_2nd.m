...
init_C_file = strcat(file_dir, filesep, strcat(targetDate, '_calculation_init_4.5-6.0.csv'));   % For 3.0 m to 4.5 m
init_D_file = strcat(file_dir, filesep, strcat(targetDate, '_calculation_init_6.0-10.0.csv'));   % For 3.0 m to 4.5 m
