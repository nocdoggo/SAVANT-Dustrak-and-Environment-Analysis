...
for idx = 1:num_NC
    ...
    % 15 Meter Level
    try
        spd_15m_rel=ncread(currFile,'spd_15m_rel');
    catch
        errmsg('red','Spd_15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        spd_15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % 20 Meter Level
    try
        spd_20m_rel=ncread(currFile,'spd_20m_rel');
    catch
        errmsg('red','Spd_20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        spd_20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        u_1_5m_init = ncread(currFile,'u_1_5m_init');
    catch
        errmsg('red','u_1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_3m_init = ncread(currFile,'u_3m_init');
    catch
        errmsg('red','u_3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_4_5m_init = ncread(currFile,'u_4_5m_init');
    catch
        errmsg('red','u_4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_6m_init = ncread(currFile,'u_6m_init');
    catch
        errmsg('red','u_6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_10m_init = ncread(currFile,'u_10m_init');
    catch
        errmsg('red','u_10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        u_1_5m_rel = ncread(currFile,'u_1_5m_rel');
    catch
        errmsg('red','u_1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_3m_rel = ncread(currFile,'u_3m_rel');
    catch
        errmsg('red','u_3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_4_5m_rel = ncread(currFile,'u_4_5m_rel');
    catch
        errmsg('red','u_4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_6m_rel = ncread(currFile,'u_6m_rel');
    catch
        errmsg('red','u_6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_8_5m_rel = ncread(currFile,'u_8_5m_rel');
    catch
        errmsg('red','u_8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_10m_rel = ncread(currFile,'u_10m_rel');
    catch
        errmsg('red','u_10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_15m_rel = ncread(currFile,'u_15m_rel');
    catch
        errmsg('red','u_15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_20m_rel = ncread(currFile,'u_20m_rel');
    catch
        errmsg('red','u_20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        v_1_5m_init = ncread(currFile,'v_1_5m_init');
    catch
        errmsg('red','v_1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_3m_init = ncread(currFile,'v_3m_init');
    catch
        errmsg('red','v_3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_4_5m_init = ncread(currFile,'v_4_5m_init');
    catch
        errmsg('red','v_4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_6m_init = ncread(currFile,'v_6m_init');
    catch
        errmsg('red','v_6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_10m_init = ncread(currFile,'v_10m_init');
    catch
        errmsg('red','v_10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        v_1_5m_rel = ncread(currFile,'v_1_5m_rel');
    catch
        errmsg('red','v_1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_3m_rel = ncread(currFile,'v_3m_rel');
    catch
        errmsg('red','v_3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_4_5m_rel = ncread(currFile,'v_4_5m_rel');
    catch
        errmsg('red','v_4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_6m_rel = ncread(currFile,'v_6m_rel');
    catch
        errmsg('red','v_6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_8_5m_rel = ncread(currFile,'v_8_5m_rel');
    catch
        errmsg('red','v_8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_10m_rel = ncread(currFile,'v_10m_rel');
    catch
        errmsg('red','v_10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_15m_rel = ncread(currFile,'v_15m_rel');
    catch
        errmsg('red','v_15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_20m_rel = ncread(currFile,'v_20m_rel');
    catch
        errmsg('red','v_20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        w_1_5m_init = ncread(currFile,'w_1_5m_init');
    catch
        errmsg('red','w_1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_3m_init = ncread(currFile,'w_3m_init');
    catch
        errmsg('red','w_3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_4_5m_init = ncread(currFile,'w_4_5m_init');
    catch
        errmsg('red','w_4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_6m_init = ncread(currFile,'w_6m_init');
    catch
        errmsg('red','w_6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_10m_init = ncread(currFile,'w_10m_init');
    catch
        errmsg('red','w_10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        w_1_5m_rel = ncread(currFile,'w_1_5m_rel');
    catch
        errmsg('red','w_1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_3m_rel = ncread(currFile,'w_3m_rel');
    catch
        errmsg('red','w_3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_4_5m_rel = ncread(currFile,'w_4_5m_rel');
    catch
        errmsg('red','w_4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_6m_rel = ncread(currFile,'w_6m_rel');
    catch
        errmsg('red','w_6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_8_5m_rel = ncread(currFile,'w_8_5m_rel');
    catch
        errmsg('red','w_8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_10m_rel = ncread(currFile,'w_10m_rel');
    catch
        errmsg('red','w_10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_15m_rel = ncread(currFile,'w_15m_rel');
    catch
        errmsg('red','w_15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_20m_rel = ncread(currFile,'w_20m_rel');
    catch
        errmsg('red','w_20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        tc_1_5m_init = ncread(currFile,'tc_1_5m_init');
    catch
        errmsg('red','tc_1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_3m_init = ncread(currFile,'tc_3m_init');
    catch
        errmsg('red','tc_3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_4_5m_init = ncread(currFile,'tc_4_5m_init');
    catch
        errmsg('red','tc_4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_6m_init = ncread(currFile,'tc_6m_init');
    catch
        errmsg('red','tc_6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_10m_init = ncread(currFile,'tc_10m_init');
    catch
        errmsg('red','tc_10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        tc_1_5m_rel = ncread(currFile,'tc_1_5m_rel');
    catch
        errmsg('red','tc_1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_3m_rel = ncread(currFile,'tc_3m_rel');
    catch
        errmsg('red','tc_3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_4_5m_rel = ncread(currFile,'tc_4_5m_rel');
    catch
        errmsg('red','tc_4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_6m_rel = ncread(currFile,'tc_6m_rel');
    catch
        errmsg('red','tc_6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_8_5m_rel = ncread(currFile,'tc_8_5m_rel');
    catch
        errmsg('red','tc_8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_10m_rel = ncread(currFile,'tc_10m_rel');
    catch
        errmsg('red','tc_10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_15m_rel = ncread(currFile,'tc_15m_rel');
    catch
        errmsg('red','tc_15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        tc_20m_rel = ncread(currFile,'tc_20m_rel');
    catch
        errmsg('red','tc_20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        tc_20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Uconv Tower
    try
        u_w__1_5m_uconv = ncread(currFile,'u_w__1_5m_uconv');
    catch
        errmsg('red','u_w__1_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__1_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__3m_uconv = ncread(currFile,'u_w__3m_uconv');
    catch
        errmsg('red','u_w__3m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__3m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__4_5m_uconv = ncread(currFile,'u_w__4_5m_uconv');
    catch
        errmsg('red','u_w__4_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__4_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__6m_uconv = ncread(currFile,'u_w__6m_uconv');
    catch
        errmsg('red','u_w__6m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__6m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__10m_uconv = ncread(currFile,'u_w__10m_uconv');
    catch
        errmsg('red','u_w__10m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__10m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Lconv Tower
    try
        u_w__1_5m_lconv = ncread(currFile,'u_w__1_5m_lconv');
    catch
        errmsg('red','u_w__1_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__1_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__3m_lconv = ncread(currFile,'u_w__3m_lconv');
    catch
        errmsg('red','u_w__3m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__3m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__4_5m_lconv = ncread(currFile,'u_w__4_5m_lconv');
    catch
        errmsg('red','u_w__4_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__4_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__6m_lconv = ncread(currFile,'u_w__6m_lconv');
    catch
        errmsg('red','u_w__6m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__6m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__8_5m_lconv = ncread(currFile,'u_w__8_5m_lconv');
    catch
        errmsg('red','u_w__8_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__8_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__10m_lconv = ncread(currFile,'u_w__10m_lconv');
    catch
        errmsg('red','u_w__10m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__10m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__15m_lconv = ncread(currFile,'u_w__15m_lconv');
    catch
        errmsg('red','u_w__15m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__15m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_w__20m_lconv = ncread(currFile,'u_w__20m_lconv');
    catch
        errmsg('red','u_w__20m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_w__20m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Uconv Tower
    try
        v_w__1_5m_uconv = ncread(currFile,'v_w__1_5m_uconv');
    catch
        errmsg('red','v_w__1_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__1_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__3m_uconv = ncread(currFile,'v_w__3m_uconv');
    catch
        errmsg('red','v_w__3m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__3m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__4_5m_uconv = ncread(currFile,'v_w__4_5m_uconv');
    catch
        errmsg('red','v_w__4_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__4_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__6m_uconv = ncread(currFile,'v_w__6m_uconv');
    catch
        errmsg('red','v_w__6m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__6m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__10m_uconv = ncread(currFile,'v_w__10m_uconv');
    catch
        errmsg('red','v_w__10m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__10m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Lconv Tower
    try
        v_w__1_5m_lconv = ncread(currFile,'v_w__1_5m_lconv');
    catch
        errmsg('red','v_w__1_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__1_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__3m_lconv = ncread(currFile,'v_w__3m_lconv');
    catch
        errmsg('red','v_w__3m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__3m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__4_5m_lconv = ncread(currFile,'v_w__4_5m_lconv');
    catch
        errmsg('red','v_w__4_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__4_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__6m_lconv = ncread(currFile,'v_w__6m_lconv');
    catch
        errmsg('red','v_w__6m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__6m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__8_5m_lconv = ncread(currFile,'v_w__8_5m_lconv');
    catch
        errmsg('red','v_w__8_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__8_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__10m_lconv = ncread(currFile,'v_w__10m_lconv');
    catch
        errmsg('red','v_w__10m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__10m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__15m_lconv = ncread(currFile,'v_w__15m_lconv');
    catch
        errmsg('red','v_w__15m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__15m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_w__20m_lconv = ncread(currFile,'v_w__20m_lconv');
    catch
        errmsg('red','v_w__20m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_w__20m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Uconv Tower
    try
        u_u__1_5m_uconv = ncread(currFile,'u_u__1_5m_uconv');
    catch
        errmsg('red','u_u__1_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__1_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__3m_uconv = ncread(currFile,'u_u__3m_uconv');
    catch
        errmsg('red','u_u__3m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__3m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__4_5m_uconv = ncread(currFile,'u_u__4_5m_uconv');
    catch
        errmsg('red','u_u__4_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__4_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__6m_uconv = ncread(currFile,'u_u__6m_uconv');
    catch
        errmsg('red','u_u__6m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__6m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__10m_uconv = ncread(currFile,'u_u__10m_uconv');
    catch
        errmsg('red','u_u__10m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__10m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Lconv Tower
    try
        u_u__1_5m_lconv = ncread(currFile,'u_u__1_5m_lconv');
    catch
        errmsg('red','u_u__1_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__1_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__3m_lconv = ncread(currFile,'u_u__3m_lconv');
    catch
        errmsg('red','u_u__3m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__3m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__4_5m_lconv = ncread(currFile,'u_u__4_5m_lconv');
    catch
        errmsg('red','u_u__4_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__4_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__6m_lconv = ncread(currFile,'u_u__6m_lconv');
    catch
        errmsg('red','u_u__6m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__6m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__8_5m_lconv = ncread(currFile,'u_u__8_5m_lconv');
    catch
        errmsg('red','u_u__8_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__8_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__10m_lconv = ncread(currFile,'u_u__10m_lconv');
    catch
        errmsg('red','u_u__10m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__10m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__15m_lconv = ncread(currFile,'u_u__15m_lconv');
    catch
        errmsg('red','u_u__15m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__15m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__20m_lconv = ncread(currFile,'u_u__20m_lconv');
    catch
        errmsg('red','u_u__20m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__20m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        u_u__1_5m_init = ncread(currFile,'u_u__1_5m_init');
    catch
        errmsg('red','u_u__1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__3m_init = ncread(currFile,'u_u__3m_init');
    catch
        errmsg('red','u_u__3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__4_5m_init = ncread(currFile,'u_u__4_5m_init');
    catch
        errmsg('red','u_u__4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__6m_init = ncread(currFile,'u_u__6m_init');
    catch
        errmsg('red','u_u__6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__10m_init = ncread(currFile,'u_u__10m_init');
    catch
        errmsg('red','u_u__10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        u_u__1_5m_rel = ncread(currFile,'u_u__1_5m_rel');
    catch
        errmsg('red','u_u__1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__3m_rel = ncread(currFile,'u_u__3m_rel');
    catch
        errmsg('red','u_u__3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__4_5m_rel = ncread(currFile,'u_u__4_5m_rel');
    catch
        errmsg('red','u_u__4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__6m_rel = ncread(currFile,'u_u__6m_rel');
    catch
        errmsg('red','u_u__6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__8_5m_rel = ncread(currFile,'u_u__8_5m_rel');
    catch
        errmsg('red','u_u__8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__10m_rel = ncread(currFile,'u_u__10m_rel');
    catch
        errmsg('red','u_u__10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__15m_rel = ncread(currFile,'u_u__15m_rel');
    catch
        errmsg('red','u_u__15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        u_u__20m_rel = ncread(currFile,'u_u__20m_rel');
    catch
        errmsg('red','u_u__20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        u_u__20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Uconv Tower
    try
        v_v__1_5m_uconv = ncread(currFile,'v_v__1_5m_uconv');
    catch
        errmsg('red','v_v__1_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__1_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__3m_uconv = ncread(currFile,'v_v__3m_uconv');
    catch
        errmsg('red','v_v__3m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__3m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__4_5m_uconv = ncread(currFile,'v_v__4_5m_uconv');
    catch
        errmsg('red','v_v__4_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__4_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__6m_uconv = ncread(currFile,'v_v__6m_uconv');
    catch
        errmsg('red','v_v__6m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__6m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__10m_uconv = ncread(currFile,'v_v__10m_uconv');
    catch
        errmsg('red','v_v__10m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__10m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Lconv Tower
    try
        v_v__1_5m_lconv = ncread(currFile,'v_v__1_5m_lconv');
    catch
        errmsg('red','v_v__1_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__1_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__3m_lconv = ncread(currFile,'v_v__3m_lconv');
    catch
        errmsg('red','v_v__3m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__3m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__4_5m_lconv = ncread(currFile,'v_v__4_5m_lconv');
    catch
        errmsg('red','v_v__4_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__4_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__6m_lconv = ncread(currFile,'v_v__6m_lconv');
    catch
        errmsg('red','v_v__6m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__6m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__8_5m_lconv = ncread(currFile,'v_v__8_5m_lconv');
    catch
        errmsg('red','v_v__8_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__8_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__10m_lconv = ncread(currFile,'v_v__10m_lconv');
    catch
        errmsg('red','v_v__10m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__10m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__15m_lconv = ncread(currFile,'v_v__15m_lconv');
    catch
        errmsg('red','v_v__15m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__15m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__20m_lconv = ncread(currFile,'v_v__20m_lconv');
    catch
        errmsg('red','v_v__20m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__20m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        v_v__1_5m_init = ncread(currFile,'v_v__1_5m_init');
    catch
        errmsg('red','v_v__1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__3m_init = ncread(currFile,'v_v__3m_init');
    catch
        errmsg('red','v_v__3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__4_5m_init = ncread(currFile,'v_v__4_5m_init');
    catch
        errmsg('red','v_v__4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__6m_init = ncread(currFile,'v_v__6m_init');
    catch
        errmsg('red','v_v__6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__10m_init = ncread(currFile,'v_v__10m_init');
    catch
        errmsg('red','v_v__10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        v_v__1_5m_rel = ncread(currFile,'v_v__1_5m_rel');
    catch
        errmsg('red','v_v__1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__3m_rel = ncread(currFile,'v_v__3m_rel');
    catch
        errmsg('red','v_v__3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__4_5m_rel = ncread(currFile,'v_v__4_5m_rel');
    catch
        errmsg('red','v_v__4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__6m_rel = ncread(currFile,'v_v__6m_rel');
    catch
        errmsg('red','v_v__6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__8_5m_rel = ncread(currFile,'v_v__8_5m_rel');
    catch
        errmsg('red','v_v__8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__10m_rel = ncread(currFile,'v_v__10m_rel');
    catch
        errmsg('red','v_v__10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__15m_rel = ncread(currFile,'v_v__15m_rel');
    catch
        errmsg('red','v_v__15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        v_v__20m_rel = ncread(currFile,'v_v__20m_rel');
    catch
        errmsg('red','v_v__20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        v_v__20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Uconv Tower
    try
        w_w__1_5m_uconv = ncread(currFile,'w_w__1_5m_uconv');
    catch
        errmsg('red','w_w__1_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__1_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__3m_uconv = ncread(currFile,'w_w__3m_uconv');
    catch
        errmsg('red','w_w__3m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__3m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__4_5m_uconv = ncread(currFile,'w_w__4_5m_uconv');
    catch
        errmsg('red','w_w__4_5m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__4_5m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__6m_uconv = ncread(currFile,'w_w__6m_uconv');
    catch
        errmsg('red','w_w__6m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__6m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__10m_uconv = ncread(currFile,'w_w__10m_uconv');
    catch
        errmsg('red','w_w__10m_uconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__10m_uconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % Lconv Tower
    try
        w_w__1_5m_lconv = ncread(currFile,'w_w__1_5m_lconv');
    catch
        errmsg('red','w_w__1_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__1_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__3m_lconv = ncread(currFile,'w_w__3m_lconv');
    catch
        errmsg('red','w_w__3m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__3m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__4_5m_lconv = ncread(currFile,'w_w__4_5m_lconv');
    catch
        errmsg('red','w_w__4_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__4_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__6m_lconv = ncread(currFile,'w_w__6m_lconv');
    catch
        errmsg('red','w_w__6m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__6m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__8_5m_lconv = ncread(currFile,'w_w__8_5m_lconv');
    catch
        errmsg('red','w_w__8_5m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__8_5m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__10m_lconv = ncread(currFile,'w_w__10m_lconv');
    catch
        errmsg('red','w_w__10m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__10m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__15m_lconv = ncread(currFile,'w_w__15m_lconv');
    catch
        errmsg('red','w_w__15m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__15m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__20m_lconv = ncread(currFile,'w_w__20m_lconv');
    catch
        errmsg('red','w_w__20m_lconv does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__20m_lconv = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % init Tower
    try
        w_w__1_5m_init = ncread(currFile,'w_w__1_5m_init');
    catch
        errmsg('red','w_w__1_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__1_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__3m_init = ncread(currFile,'w_w__3m_init');
    catch
        errmsg('red','w_w__3m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__3m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__4_5m_init = ncread(currFile,'w_w__4_5m_init');
    catch
        errmsg('red','w_w__4_5m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__4_5m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__6m_init = ncread(currFile,'w_w__6m_init');
    catch
        errmsg('red','w_w__6m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__6m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__10m_init = ncread(currFile,'w_w__10m_init');
    catch
        errmsg('red','w_w__10m_init does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__10m_init = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    % rel Tower
    try
        w_w__1_5m_rel = ncread(currFile,'w_w__1_5m_rel');
    catch
        errmsg('red','w_w__1_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__1_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__3m_rel = ncread(currFile,'w_w__3m_rel');
    catch
        errmsg('red','w_w__3m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__3m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__4_5m_rel = ncread(currFile,'w_w__4_5m_rel');
    catch
        errmsg('red','w_w__4_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__4_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__6m_rel = ncread(currFile,'w_w__6m_rel');
    catch
        errmsg('red','w_w__6m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__6m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__8_5m_rel = ncread(currFile,'w_w__8_5m_rel');
    catch
        errmsg('red','w_w__8_5m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__8_5m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__10m_rel = ncread(currFile,'w_w__10m_rel');
    catch
        errmsg('red','w_w__10m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__10m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__15m_rel = ncread(currFile,'w_w__15m_rel');
    catch
        errmsg('red','w_w__15m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__15m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    try
        w_w__20m_rel = ncread(currFile,'w_w__20m_rel');
    catch
        errmsg('red','w_w__20m_rel does not exist in the following file: \n');
        errmsg('blue', '      %s\n',currFile)
        w_w__20m_rel = 0.* ones(len_Table,1);
        errmsg('Magenta','The data has been saved as 0!\n')
        fprintf('\n')
        flag_counter = flag_counter + 1;
    end
    ...
    elseif (out_T == 3)
        ...
        tempT_3D2 = table(CDT_time, bar_fence, u_1_5m_uconv, u_3m_uconv, u_4_5m_uconv, u_6m_uconv, u_10m_uconv, bar_fence, u_1_5m_lconv, u_3m_lconv, u_4_5m_lconv, u_6m_lconv, u_8_5m_lconv, u_10m_lconv, u_15m_lconv, u_20m_lconv, bar_fence, v_1_5m_uconv, v_3m_uconv, v_4_5m_uconv, v_6m_uconv, v_10m_uconv, bar_fence, v_1_5m_lconv, v_3m_lconv, v_4_5m_lconv, v_6m_lconv, v_8_5m_lconv, v_10m_lconv, v_15m_lconv, v_20m_lconv, ...
            ...
            bar_fence, u_w__1_5m_uconv, u_w__3m_uconv, u_w__4_5m_uconv, u_w__6m_uconv, u_w__10m_uconv, bar_fence, u_w__1_5m_lconv, u_w__3m_lconv, u_w__4_5m_lconv, u_w__6m_lconv, u_w__8_5m_lconv, u_w__10m_lconv, u_w__15m_lconv, u_w__20m_lconv,...
            bar_fence, v_w__1_5m_uconv, v_w__3m_uconv, v_w__4_5m_uconv, v_w__6m_uconv, v_w__10m_uconv, bar_fence, v_w__1_5m_lconv, v_w__3m_lconv, v_w__4_5m_lconv, v_w__6m_lconv, v_w__8_5m_lconv, v_w__10m_lconv, v_w__15m_lconv, v_w__20m_lconv,...
            bar_fence, u_1_5m_init, u_3m_init, u_4_5m_init, u_6m_init, u_10m_init, bar_fence, u_1_5m_rel, u_3m_rel, u_4_5m_rel, u_6m_rel, u_8_5m_rel, u_10m_rel, u_15m_rel, u_20m_rel,...
            bar_fence, v_1_5m_init, v_3m_init, v_4_5m_init, v_6m_init, v_10m_init, bar_fence, v_1_5m_rel, v_3m_rel, v_4_5m_rel, v_6m_rel, v_8_5m_rel, v_10m_rel, v_15m_rel, v_20m_rel, ...
            bar_fence, w_1_5m_init, w_3m_init, w_4_5m_init, w_6m_init, w_10m_init, bar_fence, w_1_5m_rel, w_3m_rel, w_4_5m_rel, w_6m_rel, w_8_5m_rel, w_10m_rel, w_15m_rel, w_20m_rel, ...
            bar_fence, tc_1_5m_init, tc_3m_init, tc_4_5m_init, tc_6m_init, tc_10m_init, bar_fence, tc_1_5m_rel, tc_3m_rel, tc_4_5m_rel, tc_6m_rel, tc_8_5m_rel, tc_10m_rel, tc_15m_rel, tc_20m_rel, ...
            bar_fence, w_tc__1_5m_init, w_tc__3m_init, w_tc__4_5m_init, w_tc__6m_init, w_tc__10m_init, bar_fence, w_tc__1_5m_rel, w_tc__3m_rel, w_tc__4_5m_rel, w_tc__6m_rel, w_tc__8_5m_rel, w_tc__10m_rel, w_tc__15m_rel, w_tc__20m_rel,...
            bar_fence, u_w__1_5m_init, u_w__3m_init, u_w__4_5m_init, u_w__6m_init, u_w__10m_init, bar_fence, u_w__1_5m_rel, u_w__3m_rel, u_w__4_5m_rel, u_w__6m_rel, u_w__8_5m_rel, u_w__10m_rel, u_w__15m_rel, u_w__20m_rel,...
            bar_fence, v_w__1_5m_init, v_w__3m_init, v_w__4_5m_init, v_w__6m_init, v_w__10m_init, bar_fence, v_w__1_5m_rel, v_w__3m_rel, v_w__4_5m_rel, v_w__6m_rel, v_w__8_5m_rel, v_w__10m_rel, v_w__15m_rel, v_w__20m_rel,...
            bar_fence, u_u__1_5m_init, u_u__3m_init, u_u__4_5m_init, u_u__6m_init, u_u__10m_init, bar_fence, u_u__1_5m_rel, u_u__3m_rel, u_u__4_5m_rel, u_u__6m_rel, u_u__8_5m_rel, u_u__10m_rel, u_u__15m_rel, u_u__20m_rel,...
            bar_fence, u_u__1_5m_uconv, u_u__3m_uconv, u_u__4_5m_uconv, u_u__6m_uconv, u_u__10m_uconv, bar_fence, u_u__1_5m_lconv, u_u__3m_lconv, u_u__4_5m_lconv, u_u__6m_lconv, u_u__8_5m_lconv, u_u__10m_lconv, u_u__15m_lconv, u_u__20m_lconv,...
            bar_fence, v_v__1_5m_init, v_v__3m_init, v_v__4_5m_init, v_v__6m_init, v_v__10m_init, bar_fence, v_v__1_5m_rel, v_v__3m_rel, v_v__4_5m_rel, v_v__6m_rel, v_v__8_5m_rel, v_v__10m_rel, v_v__15m_rel, v_v__20m_rel,...
